...
import type { SavesAPIType, JobsAPIType, PluginsAPIType, RommAPIType, SettingsAPIType, StoreAPIType, SystemAPIType } from "../../bun/api/rpc";
...
export const savesApi = treaty<SavesAPIType>(RPC_URL(__HOST__), options);
