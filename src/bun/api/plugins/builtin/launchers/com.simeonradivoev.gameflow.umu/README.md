...
Settings select UMU-Proton, GE-Proton, or a custom Proton directory, automatic Steam Linux Runtime updates, protonfixes, umu debug output, and Proton logs. The first launch can download Proton and the Steam Linux Runtime. No downloads occur while viewing a game's launch options.
